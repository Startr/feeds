...
(function() {
  ...
  var STYLE = [
    ...
    '.btn-play { width: 44px; height: 44px; background: var(--startr-accent, hsl(272, 98%, 26%)); color: #fff; border-radius: 50%; }',
    '.btn-play:hover { opacity: 0.85; background: var(--startr-accent, hsl(272, 98%, 26%)); }',
    ...
    '.scrubber::-webkit-slider-thumb { -webkit-appearance: none; width: 14px; height: 14px; border-radius: 50%; background: var(--startr-accent, hsl(272, 98%, 26%)); cursor: pointer; }',
    '.scrubber::-moz-range-thumb { width: 14px; height: 14px; border-radius: 50%; background: var(--startr-accent, hsl(272, 98%, 26%)); border: none; cursor: pointer; }',
    '',
    ...
    '.picker:focus { outline: 2px solid var(--startr-accent, hsl(272, 98%, 26%)); outline-offset: -1px; }',
    ...
    '.tooltip { font-size: 11px; color: var(--startr-accent, hsl(272, 98%, 26%)); font-weight: 600; }',
    '',
    '/* Loading skeleton */',
    ...
    '  .btn-play { background: var(--startr-accent, hsl(272, 70%, 55%)); }',
    '  .btn-play:hover { background: var(--startr-accent, hsl(272, 70%, 55%)); }',
    '  .scrubber::-webkit-slider-thumb { background: var(--startr-accent, hsl(272, 70%, 55%)); }',
    '  .scrubber::-moz-range-thumb { background: var(--startr-accent, hsl(272, 70%, 55%)); }',
    '  .picker:focus { outline-color: var(--startr-accent, hsl(272, 70%, 55%)); }',
    '  .tooltip { color: var(--startr-accent, hsl(272, 70%, 55%)); }',
    '  .loading { color: #999; }',
