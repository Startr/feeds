...
| Intro | 1:30-3:30 | Who Izzy and Alex are. What Sage is (one sentence). What this show is: operator-flavored commentary on the gap between what companies call "open" or "sovereign" or "safe" and what actually is. |
| The GitHub origin story | 3:30-8:00 | Preston-Werner's 2013 OSCON keynote. "Nice and short" vs "that's not what freedom is." choosealicense.com putting MIT first. The inversion: 59% copyleft in 2012 to 40% permissive by 2024. This was not organic. It was designed. Connect to Alex's quote: "The curriculum doesn't teach licensing because the companies that fund the curriculum benefit from the licence the students choose by default." |
| The curriculum gap | 8:00-12:00 | No major CS program teaches comparative licensing. Students graduate having never read a licence. Google, Amazon, Meta, Microsoft fund the programs, sponsor the hackathons, ship the tools (React, TensorFlow, VS Code, PyTorch), all permissive. The ecosystem normalizes MIT as default. The students carry the default with them. |
| The Redis story | 12:00-18:00 | Salvatore Sanfilippo. BSD licence. Amazon builds ElastiCache. Returns nothing. Redis relicenses to SSPL in 2024. Community fractures. Valkey fork backed by Amazon. External contributors with 5+ commits drops to zero. Sanfilippo returns December 2024. Redis adds AGPL May 2025. Sixteen years to learn one lesson. **"The licence you choose on day one determines who profits on day ten thousand."** |
